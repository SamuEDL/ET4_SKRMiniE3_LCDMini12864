...
#if ENABLED(HOTEND_IDLE_TIMEOUT) // Sam
 ...
 */
#define FAN_KICKSTART_TIME  100  // (ms) //Sam
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 180 //sam
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //Sam
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true //Sam //Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    #define BACKUP_POWER_SUPPLY         // Backup power / UPS to move the steppers on power loss
    #define POWER_LOSS_ZRAISE       2   // (mm) Z axis raise on resume (on power loss with UPS)
    #define POWER_LOSS_PIN         -1 //Sam // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 */
#define G29_RETRY_AND_RECOVER // Sam
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS //sam
